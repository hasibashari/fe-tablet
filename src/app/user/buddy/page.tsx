...
import { Flame, Heart, CheckCircle2, Users, Sparkles, Plus, X } from 'lucide-react';
  ...
  return (
    <div className='flex flex-col gap-6 w-full'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-6 items-start'>
        {/* LEFT COLUMN: Duo-avatarUrl Streak Hero Banner (md:col-span-5) */}
        <div className='md:col-span-5 flex flex-col gap-5'>
          <Card variant='hero' padding='lg' className='relative overflow-hidden text-center'>
            ...
            <p className='text-xs sm:text-sm text-[#475569] leading-relaxed max-w-xs mx-auto mb-5'>
              Luar biasa! Kamu dan <strong>{buddy.buddyName}</strong> sudah konsisten selama{' '}
              <strong>{buddy.streakCount} minggu berturut-turut</strong> tanpa melewatkan TTD!
            </p>
        ...
        <div className='md:col-span-7 flex flex-col gap-5'>
          ...
          <Card padding='md' className='bg-[#fdf2f4]'>
            ...
            <p className='text-xs text-[#475569] leading-relaxed'>
              Membangun kebiasaan suplementasi bersama teman sebaya (*peer encouragement*)
              melipatgandakan motivasi untuk tidak menunda minum tablet saat akhir pekan.
            </p>
          </Card>
        </div>
      </div>
