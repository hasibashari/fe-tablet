              ...
              <div className='bg-white/80 rounded-xl p-2.5 flex items-center gap-2'>
                ...
                <div>
                  ...
                  <span className='text-xs font-bold text-[#1e293b]'>
                    {userProfile.streakCount} Minggu
                  </span>
                </div>
              </div>
        ...
        <div className='md:col-span-7 lg:col-span-8 flex flex-col gap-5'>
            ...
            {menuItems.map(item => {
              ...
              const content = (
                <div className='p-4 flex items-center justify-between hover:bg-[#fff5f7] transition-colors cursor-pointer group'>
                  ...
                  <ChevronRight
                    size={17}
                    className='text-[#94a3b8] group-hover:text-[#e11d48] transition-transform group-hover:translate-x-0.5'
                  />
                </div>
              );
          ...
          <Card padding='md' className='bg-[#fff5f7]'>
            ...
            <p className='text-xs text-[#475569] leading-relaxed'>
              Seluruh catatan jadwal dan status kepatuhan konsumsi TTD tersimpan secara aman dan
              terenkripsi untuk mendukung pencegahan anemia yang akurat.
            </p>
          </Card>
        </div>
      </div>
        ...
        <div className='fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6 bg-slate-950/40 backdrop-blur-xs animate-fade-in'>
          ...
          <div className='relative z-10 w-full max-w-lg bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-6 shadow-2xl border border-[#fce7f3] max-h-[90vh] overflow-y-auto'>
            ...
            <form onSubmit={handleSaveProfile} className='flex flex-col gap-3.5'>
              ...
              <div>
                <label className='text-xs font-bold text-[#1e293b] mb-1 block'>
                  Sekolah / Institusi:
                </label>
                <input
                  type='text'
              ...
              <div>
                <label className='text-xs font-bold text-[#1e293b] mb-1 block'>
                  Kadar Hemoglobin Terakhir (g/dL):
                </label>
                <input
                  type='number'
                  step='0.1'
        ...
        <div className='fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6 bg-slate-950/40 backdrop-blur-xs animate-fade-in'>
          ...
          <div className='relative z-10 w-full max-w-sm sm:max-w-md bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-6 shadow-2xl border border-[#fce7f3] text-center'>
            ...
            <p className='text-xs sm:text-sm text-[#64748b] mt-1.5 mb-5 max-w-xs mx-auto leading-relaxed'>
              Kamu harus masuk kembali untuk memantau pengingat TTD dan mempertahankan streak
              bersama sahabatmu.
            </p>
