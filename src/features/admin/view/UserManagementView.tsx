...
export default function UserManagementView() {
  ...
  const handleSendReminderSuccess = async (channel: 'app' | 'whatsapp') => {
    ...
    showToast(
      `Pengingat berhasil dikirimkan ke ${reminderData.patientName} via ${channelName}!`,
      'success',
    );
  };
          ...
          <Grid size={{ xs: 6 }}>
            <FormControl fullWidth size='small'>
              ...
              <Select
                ...
                label='Jenis Kelamin'
                onChange={e =>
                  updateFormData({ gender: e.target.value as PatientFormData['gender'] })
                }
              >
          ...
          <Grid size={{ xs: 6 }}>
            <FormControl fullWidth size='small'>
              ...
              <Select
                ...
                label='Tingkat Risiko'
                onChange={e =>
                  updateFormData({ riskLevel: e.target.value as PatientFormData['riskLevel'] })
                }
              >
                <MenuItem value='Rendah'>Risiko Rendah</MenuItem>
                <MenuItem value='Sedang'>Risiko Sedang</MenuItem>
