...
export default function UserFormModal({
  ...
  return (
    <CrudModalDialog
      ...
      onSubmit={onSave}
      submitText={editingId ? 'Update' : 'Tambah Siswi'}
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
        ...
        <div>
          ...
          <select
            ...
            onChange={e => onUpdateFormData({ gender: e.target.value as UserGender })}
            className='w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-white text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-rose-400 focus:border-transparent transition-all'
          >
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
        <div>
          ...
          <select
            ...
            onChange={e => onUpdateFormData({ riskLevel: e.target.value as RiskLevel })}
            className='w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-white text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-rose-400 focus:border-transparent transition-all'
          >
