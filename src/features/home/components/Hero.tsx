        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2 flex flex-col items-start text-left">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-surface-soft border border-hairline text-sm text-primary mb-6 shadow-sm"
            >
            ...
            >
              <button className="inline-flex items-center justify-center gap-2 bg-primary hover:bg-primary-active text-white px-8 py-3.5 rounded-full font-medium transition-all shadow-[0_4px_14px_0_rgba(14,165,233,0.39)] hover:shadow-[0_6px_20px_rgba(14,165,233,0.23)] hover:-translate-y-0.5 cursor-pointer">
                Consult a Specialist
                <ArrowRight size={18} />
              </button>
              <button className="inline-flex items-center justify-center gap-2 bg-white border border-hairline hover:border-muted-soft hover:bg-surface-soft text-ink px-8 py-3.5 rounded-full font-medium transition-all shadow-sm cursor-pointer">
                View Clinical Data
              </button>
            </motion.div>
            ...
            <motion.div
              ...
              className="flex items-center gap-6 mt-10 pt-6 border-t border-hairline w-full"
            >
